...
const Nav = () => {
  ...
  return (
    <Nav>
        <div className={menuIcon==true ? "navbar active" : "navbar"}>
            <ul className="navbar-lists">
                ...
                <li><NavLink to="/cart" className="navbar-link cart-trolley--link"  onClick={()=>setMenuIcon(false)}><FiShoppingCart className="cart-trolley"/><span className='cart-total--item'>10</span></NavLink></li>
            </ul>
            <div className='mobile-navbar-btn'>
                <CgMenu name="manu-outline" className="mobile-nav-icon" 
